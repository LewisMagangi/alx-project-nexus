...
urlpatterns = [
    ...
    # Email verification
    path(
        "verify-email/", EmailVerificationView.as_view(), name="verify-email"
    ),
    path(
        "resend-verification/",
    ...
    path(
        "social/google/login/",
        GoogleLoginInitView.as_view(),
        name="social-google-login",
    ),
    path(
        "social/github/login/",
        GitHubLoginInitView.as_view(),
        name="social-github-login",
    ),
