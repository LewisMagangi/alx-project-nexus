...
Covers all edge cases: posts, replies, threads, retweets, quote tweets, hashtags, mentions
...
class Command(BaseCommand):
    help = "Seeds the database with comprehensive sample data including all edge cases"
        ...
        users_data = [
            {
                ...
                "profile": {
                    "bio": "Software engineer passionate about AI, web dev, and open source. Building the future one commit at a time 🚀",
            ...
            },
            {
                ...
                "password": "password123",
                "profile": {
                    "bio": "Food blogger 🍕 Exploring cuisines worldwide. Restaurant reviews & recipes. #FoodieLife",
            ...
            },
            {
                ...
                "password": "password123",
                "profile": {
                    "bio": "Certified personal trainer 💪 Helping you achieve your fitness goals. DM for coaching!",
            ...
            },
            {
                ...
                "password": "password123",
                "profile": {
                    "bio": "Digital nomad 🌍 Visiting 50 countries before 30. Travel tips & photography.",
            ...
            },
            {
                ...
                "password": "password123",
                "profile": {
                    "bio": "Avid reader 📚 Book reviews, recommendations, and literary discussions. Currently reading sci-fi.",
                    "location": "London, UK",
                }
            },
            {
                ...
                "password": "password123",
                "profile": {
                    "bio": "Music producer 🎵 Electronic & lo-fi beats. Sharing tracks and music theory.",
            ...
            },
            {
                ...
                "password": "password123",
                "profile": {
                    "bio": "Digital artist 🎨 Creating NFTs and illustrations. Commission work open!",
            ...
            },
            {
                ...
                "password": "password123",
                "profile": {
                    "bio": "Journalist 📰 Breaking news, investigative reporting. Retweets ≠ endorsements.",
            ...
            },
            {
                ...
                "password": "password123",
                "profile": {
                    "bio": "Cryptocurrency analyst 📈 Bitcoin, Ethereum, DeFi. Not financial advice!",
                    "location": "Singapore",
            ...
            },
            {
                ...
                "password": "password123",
                "profile": {
                    "bio": "Science communicator 🔬 Latest research, space exploration, and technology.",
                    "location": "Boston, MA",
                }
            },
        ]
    ...
    def _create_follows(self, users):
        ...
        # Tech cluster: tech_guru, crypto_trader, science_daily
        tech_cluster = [u for u in users if u.username in ['tech_guru', 'crypto_trader', 'science_daily']]
        # Creative cluster: art_creator, music_maven, book_worm
        creative_cluster = [u for u in users if u.username in ['art_creator', 'music_maven', 'book_worm']]
        # Lifestyle cluster: foodie_adventures, travel_nomad, fitness_coach
        lifestyle_cluster = [u for u in users if u.username in ['foodie_adventures', 'travel_nomad', 'fitness_coach']]
        ...
        for cluster in clusters:
            for user1 in cluster:
                for user2 in cluster:
                    if user1 != user2 and random.random() > 0.2:  # 80% follow rate within cluster
        ...
        for user in users:
            ...
            follows_to_create = random.sample(others, min(num_follows, len(others)))
            
            for to_follow in follows_to_create:
                if not Follow.objects.filter(follower=user, following=to_follow).exists():
    ...
    def _create_regular_posts(self, users):
        ...
        posts_templates = [
            ...
            ("Just deployed my new #Python web app using #Django and #React! Check it out 🚀", "tech_guru"),
            ("Working on a new #MachineLearning model for image classification. The results are promising! #AI #DeepLearning", "tech_guru"),
            ("Why #TypeScript is a game changer for large-scale JavaScript projects. Thread 🧵", "tech_guru"),
            
            # Food posts with mentions and hashtags
            ("Had the most amazing pasta at @italian_bistro today! The carbonara was perfection 🍝 #FoodieLife", "foodie_adventures"),
            ("Recipe of the day: Homemade sourdough bread! Tag @book_worm who loves baking 🍞 #BakingFromScratch", "foodie_adventures"),
            ("Coffee tasting at the new @coffee_roasters downtown. Best latte I've had! ☕ #CoffeeLover", "foodie_adventures"),
            
            # Fitness posts with hashtags
            ("Morning workout complete! 5K run + strength training 💪 #FitnessMotivation #HealthyLifestyle", "fitness_coach"),
            ("New blog post: Top 10 exercises for building core strength. Link in bio! #Fitness #Workout", "fitness_coach"),
            ("Remember: consistency > intensity. Small daily improvements lead to big results! #FitnessJourney", "fitness_coach"),
            
            # Travel posts with hashtags and mentions
            ("Sunset at Uluwatu Temple, Bali 🌅 Simply breathtaking! @travel_nomad #TravelPhotography #Bali", "travel_nomad"),
            ("Pro tip: Visit temples early morning to avoid crowds and catch the sunrise! #TravelTips", "travel_nomad"),
            ("Next destination: Japan 🇯🇵 Can't wait to explore Tokyo! Any recommendations @art_creator? #TravelPlanning", "travel_nomad"),
            
            # Book posts with hashtags
            ("Just finished 'Project Hail Mary' by Andy Weir. What a ride! 📚 #BookReview #SciFi", "book_worm"),
            ("Currently reading list: 5 sci-fi novels that will blow your mind 🤯 #BookRecommendations", "book_worm"),
            ("Book club meeting tonight! Discussing '1984'. @news_reporter you should join us! #BookClub", "book_worm"),
            
            # Music posts with hashtags
            ("New track out now! 'Midnight Dreams' - lo-fi beats for studying 🎵 #LoFi #ChillBeats", "music_maven"),
            ("Working on a new EP. Here's a sneak peek of the first track 🎧 #MusicProduction", "music_maven"),
            ("The theory behind chord progressions in electronic music. Thread 🧵 #MusicTheory", "music_maven"),
            
            # Art posts with hashtags
            ("Latest digital painting: 'Cyberpunk Cityscape' 🎨 #DigitalArt #NFT", "art_creator"),
            ("Commission work is now open! DM for details and pricing 💼 #ArtCommissions", "art_creator"),
            ("Tutorial: How to create realistic lighting in digital paintings #ArtTutorial", "art_creator"),
            
            # News posts with hashtags
            ("Breaking: New climate report shows significant changes. Full coverage at 6PM 📰 #ClimateChange #News", "news_reporter"),
            ("Investigative piece on tech industry practices published today. Thread 🧵 #Journalism", "news_reporter"),
            ("Important update on the ongoing situation. Stay tuned for developments. #BreakingNews", "news_reporter"),
            
            # Crypto posts with hashtags
            ("Bitcoin breaks $50K! Analysis and market outlook 📈 #Bitcoin #Crypto", "crypto_trader"),
            ("Understanding DeFi: A beginner's guide to decentralized finance #DeFi #Blockchain", "crypto_trader"),
            ("Warning: Watch out for these common crypto scams. Stay safe! ⚠️ #CryptoSafety", "crypto_trader"),
            
            # Science posts with hashtags
            ("New exoplanet discovered in habitable zone! 🪐 #SpaceExploration #Astronomy", "science_daily"),
            ("Study shows promising results in cancer treatment research 🔬 #MedicalResearch", "science_daily"),
            ("The James Webb telescope captures stunning new images 🌌 #JWST #Space", "science_daily"),
        ]
        ...
        for content, username in posts_templates:
            ...
            for position, tag_text in enumerate(hashtag_matches):
                ...
                if tag_normalized:
                    ...
                    # Update use_count
                    Hashtag.objects.filter(pk=hashtag.pk).update(use_count=hashtag.use_count + 1)
            
            # Extract and create mentions
            mention_matches = Mention.extract_from_content(content)
            for position, mentioned_username in enumerate(mention_matches):
                try:
    ...
    def _create_threaded_replies(self, users, parent_posts):
        ...
        posts_with_threads = random.sample(parent_posts, min(10, len(parent_posts)))
        ...
        for root_post in posts_with_threads:
            ...
            for _ in range(num_replies):
                reply_user = random.choice([u for u in users if u != root_post.user])
                ...
                reply = Post.objects.create(
                    ...
                    root_post=root_post,  # Points to the root
                    created_at=root_post.created_at + timedelta(hours=random.randint(1, 12))
                )
            ...
            for first_reply in first_level_replies:
                if random.random() > 0.5:  # 50% chance of nested reply
                    nested_reply_user = random.choice([u for u in users if u != first_reply.user])
                    ...
                    nested_reply = Post.objects.create(
                        ...
                        root_post=root_post,  # Still points to original root
                        created_at=first_reply.created_at + timedelta(hours=random.randint(1, 6))
                    )
            ...
            for retweeter in retweeters:
                ...
                if not Post.objects.filter(
                    ...
                    retweet = Post.objects.create(
                        user=retweeter,
                        content="",  # Pure retweet has no content
                        retweet_of=original_post,
                        is_quote_tweet=False,
                        created_at=original_post.created_at + timedelta(hours=random.randint(1, 48))
                    )
        ...
        for original_post in posts_to_quote:
            ...
            for quoter in quoters:
                ...
                quote_tweet = Post.objects.create(
                    ...
                    retweet_of=original_post,
                    is_quote_tweet=True,
                    created_at=original_post.created_at + timedelta(hours=random.randint(1, 72))
                )
    ...
    def _create_likes(self, users, posts):
        ...
        for post in posts:
            ...
            num_likes = base_likes if random.random() > 0.3 else random.randint(8, 15)
            ...
            for liker in likers:
                ...
                if created:
                    ...
                    # Create notification (only for post owner, not for replies)
    ...
    def _create_bookmarks(self, users, posts):
        ...
        for user in users:
            ...
            posts_to_bookmark = random.sample(posts, min(num_bookmarks, len(posts)))
    ...
    def _display_summary(self):
        ...
        summary_data = [
            ...
            ("Reply Posts", Post.objects.filter(parent_post__isnull=False).count()),
        ...
        for hashtag in top_hashtags:
            self.stdout.write(f"  #{hashtag.tag:<20} ({hashtag.use_count} uses)")
